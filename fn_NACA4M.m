function [Name,Coordinates] = fn_NACA4M(Max_Camber,Dist_Max_Camber,Max_Thick,LE_Radius,Dist_Max_Thick)
% NACA 4 Modified Series
%
...
% Fifth Digit : -
% Sixth Digit : Leading edge radius [3-9] 3-Sharper 9-Blunt
% Seventh Digit :Position of the maximum thickness in 1/10 of the chord [1-9]
%----------------------------------------------------------
% Example : Naca 2315-64
% Usage: [Name,Coordinates] = fn_NACA4M(2,3,15,6,4);
% 2 = Maximum camber 2%
% 3 = Distance of maximum camber in 30% of the chord
% 15 = Maximum thickness 15%
% - Hyphen
% 6= Leading edge radius Normal = 6
% 4= Maximum thickness at 40% of the chord
%
...
Name = sprintf('%d%d%02d-%d%d',Max_Camber,Dist_Max_Camber,Max_Thick,LE_Radius,Dist_Max_Thick);
